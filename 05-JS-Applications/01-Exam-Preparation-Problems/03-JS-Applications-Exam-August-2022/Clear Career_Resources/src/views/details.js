...
import { apply, getApplicationsCount, getUserApplication } from "../data/applications.js";
...
<section id="details">
    <div id="details-wrapper">
        ...
        <div id="action-buttons">
            ...
            : html`
            <a @click=${onApply} style="visibility:hidden;"  href="javascript:void(0)" id="apply-btn">Apply</a>`}
        </div>`
        : null
        }
    </div>
